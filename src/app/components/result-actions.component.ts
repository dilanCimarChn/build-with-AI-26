...
@Component({
  ...
  template: `
    <div class="actions">
      <button class="primary" (click)="download()">⬇️ Descargar index.html</button>
  ...
  styles: [`
    ...
    button { padding: .8rem 1.3rem; border-radius: 12px; font-weight: 700;
      font-size: .95rem; cursor: pointer; border: 1px solid var(--border); transition: .15s; }
